...
class HittingLoss(FeasibilityLoss):
    ...
    def call(self, q_cps, t_cps, data):
        _, q_dot_loss, q_ddot_loss, q_dddot_loss, q, q_dot, q_ddot, q_dddot, t, t_cumsum, dt = super().call(q_cps, t_cps, data)
        ...
        unscaled_losses = tf.concat([q_dot_loss, q_ddot_loss, q_dddot_loss, constraint_loss, t_loss], axis=-1)
        ...
        return model_loss, sum_constraint_loss, sum_q_dot_loss, sum_q_ddot_loss, sum_q_dddot_loss, q, q_dot, q_ddot, q_dddot, xyz, t, t_cumsum, t_loss, dt, unscaled_model_loss, jerk_loss
    ...
    def alpha_update(self, q_dot_loss, q_ddot_loss, constraint_loss, q_dddot_loss):
