...
from models.iiwa_planner import IiwaPlannerKinodynamic
from utils.dataset import _ds
from utils.execution import ExperimentHandler
from utils.plotting import plot_qs
from losses.constraint_functions import two_tables_vertical, two_tables_vertical_end
...
class args:
    ...
    out_name = 'kinodynamic7_openend_lr5em5_bs128_alphas_1e0_1em2_1em4_1em2_bars_1em5_6em3_6em2_6em1_gamma3em3'
    log_interval = 100
    learning_rate = 5e-5
    dataset_path = "./data/paper/kinodynamic7_big/train/data.tsv"
...
loss = KinodynamicLoss(N, urdf_path, two_tables_vertical_end, None, Limits.q_dot7, Limits.q_ddot7, Limits.q_dddot7, Limits.tau7)
model = IiwaPlannerKinodynamic(N, 3, loss.bsp, loss.bsp_t)
