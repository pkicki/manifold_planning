...
def compute_cartesian_losses(ee, z=0.16):
...
def check_if_plan_valid(ee, q, q_dot, q_ddot, torque, z=0.16):
    z_loss, xlow_loss, xhigh_loss, ylow_loss, yhigh_loss = compute_cartesian_losses(ee, z)
