...
from losses.p2p import P2PLoss
...
loss = P2PLoss(N, urdf_path, Limits.q_dot7, Limits.q_ddot7, Limits.q_dddot7, Limits.tau7)
...
for epoch in range(30000):
    ...
    for i, d in _ds('Train', dataset_epoch, train_size, epoch, args.batch_size):
        with tf.GradientTape(persistent=True) as tape:
            ...
            model_loss, q_dot_loss, q_ddot_loss, q_dddot_loss, torque_loss, \
            q, q_dot, q_ddot, q_dddot, torque, t, t_cumsum, t_loss, dt, unscaled_model_loss, \
    ...
    loss.alpha_update(q_dot_losses, q_ddot_losses, torque_losses)
